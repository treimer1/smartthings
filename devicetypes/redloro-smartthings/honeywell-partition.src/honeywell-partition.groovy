...
metadata {
  ...
  tiles(scale: 2) {
    ...
    standardTile("panicButton", "device.panic", width: 2, height: 2, canChangeIcon: false, decoration: "flat") {
      state "default", label:"Panic", action:"panic", icon:"st.alarm.alarm.alarm", backgroundColor:"#FF0000"
    }
    ...
    details(["partition",
             ...
             "armInstantButton", "chimeButton","panicButton"])
  }
}
...
def panic() {
    parent.sendCommand('/plugins/envisalink/panic');
}
