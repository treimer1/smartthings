...
metadata {
	definition (name: "My Z-Wave Door/Smoke Sensor", namespace: "smartthings", author: "SmartThings") {
	...
	simulator {
		// status messages
		status "smoke": "command: 2001, payload: FF"
	...
	tiles {
                standardTile("smoke", "device.smoke", width: 2, height: 2) {
                        ...
                        state "detected", label: "detected", icon: "st.alarm.smoke.smoke", backgroundColor: "#e86d13"
        }
